...
import { createNextcloudPublication, destroyNextcloudPublication, normalizeNextcloudBaseUrl, normalizePublicNextcloudSource, publicNextcloudDataUrl, type NextcloudPublication } from './nextcloud'
...
describe('collegamento Nextcloud', () => {
  ...
  it('usa il WebDAV pubblico della condivisione per leggere il JSON dal browser', () => {
    ...
    expect(normalizePublicNextcloudSource('https://cloud.example.it/nextcloud/index.php/s/abcDEF123/download')).toBe('https://cloud.example.it/nextcloud/public.php/dav/files/abcDEF123')
  })
